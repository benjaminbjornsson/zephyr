...
#define DT_DRV_COMPAT st_stm32_temp_cal_v1
#define HAS_CALIBRATION_V1 1
#elif DT_HAS_COMPAT_STATUS_OKAY(st_stm32_temp_cal_v2)
#define DT_DRV_COMPAT st_stm32_temp_cal_v2
#define HAS_CALIBRATION_V2 1
#else
#error "No compatible devicetree node found"
#endif

#if defined(HAS_CALIBRATION_V1) || defined(HAS_CALIBRATION_V2)
...
#if HAS_CALIBRATION_V1
	temp /= (cfg->avgslope * 4096) / (cfg->cal_vrefanalog * 100);
#else
